...
//	private final String WS_URL = "http://www.fas.usda.gov:8080/svcPSD_AMIS.asmx";
	
//	private final String ACTION = "http://www.fas.usda.gov:8080/wsfaspsd/getDatabyCommodity";

//	private final String WS_URL = "http://162.79.16.68:8080/svcPSD_AMIS.asmx";
//
//	private final String ACTION = "http://162.79.16.68:8080/wsfaspsd/getDatabyCommodity";

//    private final String WS_URL = "http://162.79.22.172/wsfapsd/svcPSD_AMIS.asmx";
//
//    private final String ACTION = "http://162.79.22.172/wsfapsd/getDatabyCommodity";
	...
	public List<USDABean> getDataByCommodity(String commodityCode, List<String> userCountries, List<String> userAttributes) throws WDSException {
		try {
			...
			while ((inputLine = in.readLine()) != null)
				sb.append(inputLine);
			in.close();
//			System.out.println("Commodity: " + commodityCode);
...
//		System.out.println(l.size() + " beans in " + (t1 - t0) + " millis.");
	...
	private HttpURLConnection buildConnection() throws MalformedURLException, IOException {
		...
		c.setRequestProperty("Content-Type", "application/soap+xml");
